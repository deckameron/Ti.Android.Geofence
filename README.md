...
|canNotify    		|_(Boolean)_  - If you want the notication to be shown when Geofence events get fired.
...
#### 1 ) Create a file name myService.js and right your backgroundService code.
```javascript
